...
{
    public override async Task HandleAsync(PaymentProcessedSagaEvent message, CancellationToken cancellationToken = default)
    {
        try
        {
    ...
    public override async Task CompensateAsync(PaymentProcessedSagaEvent message, CancellationToken cancellationToken = default)
    {
        try
        {
            cancellationToken.ThrowIfCancellationRequested();
