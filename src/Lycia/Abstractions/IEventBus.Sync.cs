...
public interface IEventBus
{
    ...
    /// </returns>
    void Send<TCommand>(TCommand command, Type? handlerType = null, Guid? sagaId = null, CancellationToken cancellationToken = default) where TCommand : ICommand;
    ...
    /// </returns>
    void Publish<TEvent>(TEvent @event, Type? handlerType = null, Guid? sagaId = null, CancellationToken cancellationToken = default) where TEvent : IEvent;
    ...
    /// </returns>
    IEnumerable<(byte[] Body, Type MessageType, Type HandlerType, IReadOnlyDictionary<string, object?> Headers)> Consume(bool autoAck = true, CancellationToken cancellationToken = default);
    ...
    /// </returns>
    IEnumerable<IncomingMessage> ConsumeWithAck(CancellationToken cancellationToken = default);
} 
#endif