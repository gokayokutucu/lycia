...
/// <summary>Configures the PostgreSQL backed <see cref="PostgreSqlInboxStore"/>.</summary>
public class PostgreSqlInboxOptions
{
    ...
    /// <summary>
    /// The database schema the inbox table lives in. Defaults to "public". Applied via the connection's
