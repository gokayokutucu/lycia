...
/// <summary>Configures the PostgreSQL backed <see cref="PostgreSqlSagaStore"/>.</summary>
public class PostgreSqlSagaStoreOptions
{
    ...
    /// <summary>
    /// The database schema the saga tables live in. Defaults to "public". Applied via the connection's
