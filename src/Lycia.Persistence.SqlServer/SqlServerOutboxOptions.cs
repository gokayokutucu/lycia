...
/// <summary>Configures the SQL Server backed <see cref="SqlServerOutboxStore"/>.</summary>
public class SqlServerOutboxOptions
{
    ...
    /// <summary>The database schema the Outbox table lives in. Defaults to "dbo".</summary>
    ...
    internal string OutboxTable => $"{SchemaName}.LyciaOutbox";
}
