...
using Owin;
using Sample.Payment.NetFramework481.API.Middleware;
using Sample.Payment.NetFramework481.Application;
using Sample.Payment.NetFramework481.Infrastructure;
using Serilog;
...
[assembly: OwinStartup(typeof(Sample.Payment.NetFramework481.API.Startup))]
...
public sealed class Startup
{
    public void Configuration(IAppBuilder app)
    {
        ...
        try
        {
            var dbContext = scope.Resolve<Infrastructure.Persistence.PaymentDbContext>();
