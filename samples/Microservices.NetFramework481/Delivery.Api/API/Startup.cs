...
using Owin;
using Sample.Delivery.NetFramework481.API.Middleware;
using Sample.Delivery.NetFramework481.Application;
using Sample.Delivery.NetFramework481.Infrastructure;
using Serilog;
...
[assembly: OwinStartup(typeof(Sample.Delivery.NetFramework481.API.Startup))]
...
public sealed class Startup
{
    public void Configuration(IAppBuilder app)
    {
        Log.Logger = new LoggerConfiguration()
            .Enrich.WithProperty("Service", "Delivery.Api")
        ...
        try
        {
            var dbContext = scope.Resolve<Infrastructure.Persistence.DeliveryDbContext>();
        ...
        {
            c.SingleApiVersion("v1", "Delivery API");
        ...
        Log.Information("Delivery.API started successfully");
    }
}
