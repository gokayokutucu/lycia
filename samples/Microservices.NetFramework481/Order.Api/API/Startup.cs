...
using Owin;
using Sample.Order.NetFramework481.Application;
using Sample.Order.NetFramework481.Infrastructure;
using Sample.Order.NetFramework481.API.Middleware;
using Serilog;
...
[assembly: OwinStartup(typeof(Sample.Order.NetFramework481.API.Startup))]
...
public sealed class Startup
{
    public void Configuration(IAppBuilder app)
    {
        ...
        try
        {
            var dbContext = scope.Resolve<Infrastructure.Persistence.OrderDbContext>();
